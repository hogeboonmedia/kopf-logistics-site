...
export default async function BlogPostPage({
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Blog", item: "https://kopflogisticsgroup.com/blog/" },
      { "@type": "ListItem", position: 3, name: post.title, item: `https://kopflogisticsgroup.com${post.urlPath}` },
    ],
  };
  ...
  return (
    <article>
      ...
      <div className="px-6 lg:px-10 py-14 md:py-20">
        ...
        {/* Comments — keyed by legacy year/month/slug for thread continuity */}
        <Comments
